...
export const dynamicRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['oa:remind:list'],
    children: [
      {
        path: '/index',
        component: () => import('@/views/oa/remind/index'),
        name: 'remind',
        meta: { title: '事件管理', activeMenu: '/oa/remind'}
      }
    ]
  },
  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['oa:project:list'],
    children: [
      {
        path: '/list',
        component: () => import('@/views/oa/costing/list'),
        name: 'oaCosting',
        meta: { title: '项目资金', activeMenu: '/oa/costing'}
      }
    ]
  },
  {
    ...
    children: [
      {
        path: '/index',
        component: () => import('@/views/oa/proContract/index'),
        name: 'oaContract',
        meta: { title: '项目合同管理', activeMenu: '/oa/proContract'}
      }
    ]
  },
  {

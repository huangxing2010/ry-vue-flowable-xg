<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="流程标题" prop="description">
        <el-input
...
<!--      <el-table-column label="任务编号" align="center" prop="taskId" :show-overflow-tooltip="true"/>-->
      ...
      <el-table-column label="流程名称" align="left" prop="procDefName" width="180" :show-overflow-tooltip="true"/>
<!--      <el-table-column label="任务节点" align="center" prop="taskName" />-->
      <el-table-column label="发起人" align="center" width="180">
        <template slot-scope="scope">
          <label>{{scope.row.startUserName}}({{scope.row.deptName}})</label>
        </template>
      </el-table-column>
    ...
    getList() {
      ...
      listFinishedProcess(this.queryParams).then(response => {
         ...
         if(this.queryParams.description != null){
          this.finishedList = this.searchList(response.rows, this.queryParams.description);
         }else {

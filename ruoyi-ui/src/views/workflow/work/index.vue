...
<!--      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" fit :data="processList" @selection-change="change" :default-sort="{ prop: 'deploymentTime', order: 'descending' }" >
      <el-table-column label="序号" type="index" width="80"></el-table-column>

      <el-table-column label="流程名称" align="left" :show-overflow-tooltip="true">
...
<!--      <el-table-column label="流程标识" align="left" prop="processKey" :show-overflow-tooltip="true" />-->
      <el-table-column label="流程分类" align="left" prop="categoryName" :formatter="categoryFormat" />
      <el-table-column label="流程版本" width="180" align="center">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    /**根据时间字段排序**/
    change({ order }) {
      if (order === "ascending") { // 正序
        this.timeSort = 1;
      } else if (order === "descending") { // 倒序
        this.timeSort  = 2;
      }
      this.query(this.timeSort);
    }
